...
typedef enum
{
    ...
    Smpt_Result_Last_Item =  Smpt_Result_Pulse_Low_Current_Error /* Adjust this line if another enum item
                                                                      is added. */
...
typedef enum
{
    Smpt_Length_Number_Of_Channels = 8,
...
#ifdef UC_MAIN
    Smpt_Length_Max_Packet_Size_No_Emg   = 576,
#else
    Smpt_Length_Max_Packet_Size_No_Emg   = 1200,
...
typedef enum
{
    ...
    Smpt_Connector_Undefined = -1
} Smpt_Connector; /**< \enum Smpt_Connector Connector Types */
...
typedef enum /* Smpt_Measurement */
{
    Smpt_Measurement_None = 0,
    Smpt_Measurement_Stim_Current      = 1,
    Smpt_Measurement_Stim_Voltage      = 2,
    Smpt_Measurement_High_Voltage = 3,
    Smpt_Measurement_Last_Item = Smpt_Measurement_High_Voltage

} Smpt_Measurement; /**< \enum Smpt_Measurement Values for the measurement type */
...
typedef enum /* Smpt_Main_Status */
{
    Smpt_Fw_Hash_Type_Uninitialized  = 0,
    Smpt_Fw_Hash_Type_Git            = 1,
    Smpt_Fw_Hash_Type_Elf_MD5        = 2,
    Smpt_Fw_Hash_Type_Elf_Sha256     = 3,
    Smpt_Fw_Hash_Type_Last_Item      = Smpt_Fw_Hash_Type_Elf_Sha256

} Smpt_Fw_Hash_Type; /**< \enum Smpt_Main_Status */

typedef enum /* Smpt_Main_Status */
{
    Smpt_Fw_Hash_State_Not_Valid  = 0,
    Smpt_Fw_Hash_State_Valid            = 1,
    Smpt_Fw_Hash_State_Last_Item      = Smpt_Fw_Hash_State_Valid

} Smpt_Fw_Hash_State_Type; /**< \enum Smpt_Main_Status */

typedef struct /* Smpt_get_extended_version_ack */
{
    uint8_t         packet_number;    /**< [0 - 63] Packet number echo */
    Smpt_Result     result;           /**< \see Smpt_Result */
    Smpt_uc_version uc_version;       /**< \see Smpt_uc_version */
    uint32_t        fw_hash;          /**< \see Returns the beginning of the used FW hash (either git hash/file hash */
    Smpt_Fw_Hash_Type fw_hash_type;   /**< \see Smpt_Fw_Hash_Type */
    Smpt_Fw_Hash_State_Type   fw_hash_state; /**< \see True, when the hash is a valid (all files checked in for git) */

} Smpt_get_extended_version_ack; /**< \struct Smpt_get_extended_version_ack
                             Struct for the get_extended_version_ack response.*/
...
* \brief Clears the struct (sets all values to 0).
*
* \param[in,out] smpt_clear_get_extended_version_ack
*******************************************************************************/
...
/***************************************************************************//**
* \brief Checks if a command is a dyscom command.
*
* \param[in] cmd
*******************************************************************************/
